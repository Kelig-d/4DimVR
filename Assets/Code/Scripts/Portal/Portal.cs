...
public class Portal : MonoBehaviour
{
    ...
    {
        if (other.CompareTag("Player")) other.gameObject.transform.position = new Vector3(OtherPortal.transform.position.x, OtherPortal.transform.position.y-1.9f, other.transform.position.z);
       // other.gameObject.transform.rotation = Quaternion.LookRotation(other.transform.position - transform.position);
    }
